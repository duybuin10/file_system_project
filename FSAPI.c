...
*
* File: FSAPI.c
* Description: FSAPI.c is a file that contains helper functions that are used by other files through 
* out the file system. These functions were meant to be single purpose logic that was needed in diffenent files
**************************************************************/
#include "FSAPI.h"
#include "string.h"
